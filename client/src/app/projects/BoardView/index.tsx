...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
    ...
    if (error) return <div>An error occured wile fetching tasks</div>
    return (
        <DndProvider
            backend={HTML5Backend}
        >
            <div className='grid grid-cols-1 g-4 p-4 md:grid-cols-2 xl:grid-cols-4'>
...
const Task = ({ task }: TaskProps) => {
    ...
    const formattedDeuDate = task.dueDate ? format(new Date(task.dueDate), "P") : "";
            ...
            <div className='p-4 md:p-6'>
                ...
                <div className='my-3 flex justify-between'>
                    ...
                    {typeof task.points === "number" && (
                        <div className='text-xm font-semibold dark:text-white'>
                            {task.points} pts
                        </div>
                    )}
                </div>
                <div className='text-xs text-gray-500 dark:text-neutral-500'>
                    ...
                    {formattedDeuDate && <span>{formattedDeuDate}</span>}
                </div>
