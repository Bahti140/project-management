        ...
        <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black'>
            ...
            <div className='flex items-center gap-8'>
                ...
                <div className='relative flex h-min w-[200px]'>
                    ...
                    <input
                        className='w-full rounded border-none bg-gray-100 p2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white'
